...
final class PDFExtractor {
    ...
    func extract(url: URL, maxPages: Int) -> PDFExtractionResult {
...
extension PDFExtractor {
    /// Convert PDFExtractionResult to ExtractionDetails for logging
    /// - Parameters:
    ...
    static func makeExtractionDetails(
        from result: PDFExtractionResult,
